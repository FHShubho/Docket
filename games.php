...
<?php
 ...
 ?>
    ...
    if($post){
      while ($data=$post->fetch_assoc()) {?>
	  <?php $tmp6=$data['images'];
			$tmp7 = str_replace('thumb', 'cover_small', $tmp6);

			?>


		<div class="movie-item-style-2 movie-item-style-1">
   <img class="book-single" src="<?php echo $tmp7 ; ?>" alt="">
   <h6><a href="#"><?php echo $data['name'];?></a></h6>
	<p class="rate"><img src="images/rating.png" width="15px"><span><b><?php echo $data['ratings']?></b></span> /10</p>
...
<?php $tmp8=$data['images'];
			$tmp9 = str_replace('thumb', 'cover_small', $tmp8);
