                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
				    <div class="movie-single-ct main-content">
						<h1 class="book-title"><?php echo $title ?><br>
							...
							<a id="shelf">In Collection</a></span></h1><br>
								
                        <div class="ratings">	
						My Rating <img src="images/rating.png" width="25px"> <span><input type="number" id="" name="" value="10" min="0" max='10'></span> /10 <input type="submit" class="button" value="Update"> <br>
						Episode Seen <img src="images/timer.png" width="25px"> <span><input type="number" id="" name="" value="2" min="0" max=<?php echo $episodes?>></span> /<?php echo $episodes?> <input type="submit" class="button" value="Update"> <br>
						Add to:&nbsp; 
