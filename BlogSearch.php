...
<!-- section title -->
<div class="sectionTitle" style="margin-left: 10%;padding-top: 20px;padding-bottom: 0px;">
    <h3><a><span>Results from My Rewiew Blogs</span></a></h3>
    <svg height="5" width="900">
        <line x1="0" y1="0" x2="250" y2="0" style="stroke:rgb(61, 61, 61);stroke-width:1"/>
    </svg>
</div> 

<!-- result from blog list -->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				...
				$sql = "SELECT uniqueId, authorName, blogTitle, blogText, poster FROM {$db} WHERE blogTitle LIKE '%$searchBlog%' AND authorId='$userID' ";
...
<!-- section title -->
<div class="sectionTitle" style="margin-left: 10%;padding-top: 20px;padding-bottom: 0px;">
    <h3><a><span>Results from Other's Review Blogs</span></a></h3>
    <svg height="5" width="900">
        <line x1="0" y1="0" x2="250" y2="0" style="stroke:rgb(61, 61, 61);stroke-width:1"/>
    </svg>
</div> 
